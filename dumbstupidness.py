...
with open('assets.json','r') as file2:
    ...
    for (insert_row, line) in enumerate(file2):
        if phrase in line:
            response = requests.get('https://raw.githubusercontent.com/modraws/dumbstupidness/refs/heads/old-version/dumbstupidness/dumbstupidnessskins.txt')
...
with open('assets.json','r') as file2:
    ...
    for (insert_row, line) in enumerate(file2):
        if phrase in line:
            response = requests.get('https://raw.githubusercontent.com/modraws/dumbstupidness/refs/heads/old-version/dumbstupidness/dumbstupidnessreticles.txt')
...
with open('assets.json','r') as file2:
    ...
    for (insert_row, line) in enumerate(file2):
        if phrase in line:
            response = requests.get('https://raw.githubusercontent.com/modraws/dumbstupidness/refs/heads/old-version/dumbstupidness/dumbstupidnesssounds.txt')
